...
function SidebarInner({ teacher, assignments, onMobileClose, showClose = false }: TeacherSidebarProps & { showClose?: boolean }) {
  ...
  return (
    <>
      <div className="hidden lg:block">
        <SidebarInner teacher={teacher} assignments={assignments} onMobileClose={onMobileClose} />
      </div>
        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="lg:hidden"
            >
              <SidebarInner teacher={teacher} assignments={assignments} onMobileClose={onMobileClose} showClose />
            </motion.div>
          </>
        )}
      </AnimatePresence>
