    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "bg-card text-heading border border-border",
          "shadow-pop rounded-xl p-6 gap-4",
        ...
        {showClose && (
          <DialogPrimitive.Close
            className={cn(
              ...
              "transition-colors focus:outline-none focus:ring-2 focus:ring-border focus:ring-offset-2 focus:ring-offset-card"
            )}
          >
            <X className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("font-display text-xl font-semibold leading-tight tracking-tight text-heading", className)}
    {...props}
  />
));
