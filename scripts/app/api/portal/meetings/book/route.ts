...
export async function POST(req: NextRequest) {
  try {
    ...
    if (bookingError) return dbError(bookingError, "Failed to book meeting", { route: "/api/portal/meetings/book", school_id: studentSchool?.school_id, user_id: ctx.user.id });
