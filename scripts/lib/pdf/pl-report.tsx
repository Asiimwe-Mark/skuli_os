...
const styles = StyleSheet.create({
  ...
  subtotalLabel: { fontSize: 9, fontWeight: "bold", color: "#0B1220" },
  subtotalValue: { fontSize: 9, fontWeight: "bold", color: "#0B1220" },
  netRow: {
    flexDirection: "row",
    padding: 8,
    marginTop: 10,
  ...
  netValue: { fontSize: 10, fontWeight: "bold", color: "#D97706" },
  footer: {
    marginTop: 40,
    flexDirection: "row",
