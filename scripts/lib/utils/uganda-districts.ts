export const UGANDA_DISTRICTS: readonly string[] = [
  ...
  "Kabarole", "Kaberamaido", "Kagadi", "Kakumiro", "Kalaki", "Kaliro",
  "Kalangala", "Kaliro", "Kalungu", "Kampala", "Kamuli", "Kamwenge",
  "Kanungu", "Kapchorwa", "Kapelebyong", "Karenga", "Kasanda", "Kasese",
  "Katakwi", "Kayunga", "Kazo", "Kibaale", "Kiboga", "Kibuku", "Kikuube",
  "Kiruhura", "Kiryandongo", "Kisoro", "Kitagwenda", "Kitgum", "Koboko",
  "Kole", "Kotido", "Kumi", "Kwania", "Kween", "Kyegegwa", "Kyenjojo",
