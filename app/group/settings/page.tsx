  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-heading text-sm">Manage your school group</p>
      </div>
      ...
      <Card className="bg-card">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            {admins.map((admin) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-heading">{admin.user?.phone || "No phone"}</p>
                </div>
                <Button
                  variant="ghost"
                  size="icon"
            ...
            {admins.length === 0 && (
              <p className="text-sm text-heading py-4 text-center">No group admins yet</p>
            )}
          </div>
