...
export default function PromotePage() {
  ...
  async function handlePromote() {
    ...
    try {
      ...
      // attendance sheets, and marks sheets all change when classes move.
            ...
            <CardContent className="p-6">
                ...
                <div className="space-y-5">
                  ...
                  {mappings.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {/* Header */}
                      <div className="hidden sm:grid grid-cols-12 gap-3 px-3 text-xs font-medium text-heading uppercase">
              ...
              {step === 2 && (
                <div className="space-y-5">
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="bg-bg-tertiary border-b border-border">
                          ...
                          <th className="px-4 py-2 text-right text-xs font-medium text-heading uppercase">
                            Students
                          </th>
                        </tr>
                      </thead>
                  ...
                  <div className="p-4 rounded-lg bg-warning-50 border border-warning-50">
