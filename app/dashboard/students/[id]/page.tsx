...
function AttendanceCalendar({ attendance }: { attendance: AttendanceRecord[] }) {
  ...
  function getDayClass(date: Date): string {
    ...
    if (status === "late") return "bg-amber-400 text-navy-900";
    if (status === "excused") return "bg-blue-500 text-white";
    if (isWeekend) return "bg-navy-700/50 text-foreground/30";
    return "bg-navy-800 text-foreground/60";
  }
...
export default function StudentProfilePage() {
  ...
  async function loadTerms() {
    ...
    if (data) {
      ...
      const current = data.find((t: Term) => t.is_current);
      if (current) setSelectedTermId(current.id);
      else if (data.length > 0) setSelectedTermId(data[0].id);
    }
  }
          ...
          <CardContent className="p-6">
            <div className="flex flex-col sm:flex-row items-start gap-5">
              ...
              {student.photo_url ? (
                ...
                <div className="w-20 h-20 rounded-xl bg-amber-400/20 flex items-center justify-center text-amber-400 text-2xl font-bold">
        ...
        <Tabs defaultValue={initialTab} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              <Card className="border-border-subtle bg-surface">
                <CardContent className="p-4 text-center">
                  <p className="text-xs text-foreground/60 mb-1">Expected</p>
              ...
              <Card className="border-border-subtle bg-surface">
                <CardContent className="p-4 text-center">
                  <p className="text-xs text-foreground/60 mb-1">Paid</p>
                  ...
                  <div className="rounded-lg border border-navy-700 overflow-hidden">
                    <table className="w-full">
                      ...
                      <tbody className="divide-y divide-navy-700/50">
                        {payments.map((p) => (
                          <tr key={p.id} className="bg-navy-900">
                            ...
                            <td className="px-4 py-2 text-sm font-mono text-amber-400">
                              {p.receipt_number}
                            </td>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                <Card className="border-border-subtle bg-surface">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-xl font-bold">
                      {marks.reduce((s, m) => s + m.score, 0)} /{" "}
                      {marks.reduce((s, m) => s + m.max_score, 0)}
                    </p>
                  </CardContent>
                </Card>
                <Card className="border-border-subtle bg-surface">
                ...
                <Card className="border-border-subtle bg-surface">
                  <CardContent className="p-4 text-center">
                    <p className="text-xs text-foreground/60 mb-1">Subjects</p>
                ...
                {marks.length === 0 ? (
                  ...
                  <div className="rounded-lg border border-navy-700 overflow-hidden">
                    <table className="w-full">
                      ...
                      <tbody className="divide-y divide-navy-700/50">
                        {marks.map((m) => (
                          <tr key={m.id} className="bg-navy-900">
          ...
          <TabsContent value="attendance">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 mb-6">
              <Card className="border-border-subtle bg-surface">
                <CardContent className="p-4 text-center">
                  <p className="text-xs text-foreground/60 mb-1">Total Days</p>
              ...
              <Card className="border-border-subtle bg-surface">
                <CardContent className="p-4 text-center">
                  <p className="text-xs text-foreground/60 mb-1">Late</p>
                  <p className="text-xl font-bold text-amber-400">
                    {attStats.late}
                  </p>
                </CardContent>
              ...
              <Card className="border-border-subtle bg-surface">
                <CardContent className="p-4 text-center">
                  <p className="text-xs text-foreground/60 mb-1">Attendance Rate</p>
                  <p className={cn("text-xl font-bold", attStats.pct >= 80 ? "text-emerald-400" : attStats.pct >= 50 ? "text-amber-400" : "text-rose-400")}>
                    {attStats.pct}%
                  </p>
                </CardContent>
              </Card>
            ...
            <Card className="border-border-subtle bg-surface mb-6">
              <CardContent className="p-5">
              ...
              <CardContent>
                {attendance.length === 0 ? (
                  ...
                  <>
                    ...
                    {/* Legend */}
                    <div className="flex flex-wrap gap-4 mt-4 pt-4 border-t border-navy-600">
                      {[
                        { color: "bg-emerald-500", label: "Present" },
                        { color: "bg-rose-500", label: "Absent" },
                        { color: "bg-amber-400", label: "Late" },
                        { color: "bg-blue-500", label: "Excused" },
                        { color: "bg-navy-600", label: "No Record" },
                      ].map((item) => (
