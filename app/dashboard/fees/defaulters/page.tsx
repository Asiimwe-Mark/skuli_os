      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          <div className="bg-navy-800 border border-navy-700 rounded-xl p-5">
            <div className="flex items-start justify-between">
              ...
              <div className="p-2.5 rounded-lg bg-rose-400/10">
        ...
        >
          <div className="bg-navy-800 border border-navy-700 rounded-xl p-5">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-sm text-gray-400">Number of Defaulters</p>
                <p className="text-xl font-bold text-amber-400">{summary.count}</p>
              </div>
