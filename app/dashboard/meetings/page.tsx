  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-heading">Meeting Scheduler</h1>
          ...
          <div className="flex flex-wrap items-end gap-4">
            <div className="flex-1 min-w-[200px]">
              ...
              <select
                ...
                className="w-full mt-1 rounded-lg border border-border-strong bg-card px-3 py-2 text-sm"
              >
