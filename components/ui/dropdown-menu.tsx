...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "focus:bg-navy-50 data-[state=open]:bg-navy-700",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-lg border border-navy-50 bg-surface p-1 text-foreground shadow-xl",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "transition-colors focus:bg-navy-50 focus:text-foreground",
