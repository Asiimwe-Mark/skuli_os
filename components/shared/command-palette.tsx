    ...
    <AnimatePresence>
      {commandPaletteOpen && (
        <>
          ...
          >
            <div className="bg-navy-800 border border-navy-700 rounded-xl shadow-2xl overflow-hidden">
              {/* Search Input */}
              <div className="flex items-center gap-3 px-4 py-3 border-b border-navy-700">
                ...
                />
                <kbd className="px-1.5 py-0.5 rounded bg-navy-700 text-[10px] text-gray-500">
                  ESC
                </kbd>
              </div>
              ...
              {/* Footer */}
              <div className="px-4 py-2 border-t border-navy-700 flex items-center gap-4 text-[10px] text-gray-500">
                <span>↑↓ Navigate</span>
                <span>↵ Select</span>
                <span>ESC Close</span>
              </div>
