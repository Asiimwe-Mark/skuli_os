...
const styles = StyleSheet.create({
  ...
  infoValue: { fontSize: 9, fontWeight: "bold", color: "#0A1628" },
  ...
  summaryValue: { fontSize: 14, fontWeight: "bold", color: "#F5A623" },
  ...
  commentLabel: { fontSize: 8, fontWeight: "bold", color: "#0A1628", marginBottom: 4 },
  ...
  conductGradeText: { fontSize: 14, fontWeight: "bold", color: "#F5A623" },
  footer: {
    marginTop: 20,
    flexDirection: "row",
