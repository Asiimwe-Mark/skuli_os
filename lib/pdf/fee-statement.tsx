...
const styles = StyleSheet.create({
  ...
  value: { fontSize: 9, fontWeight: "bold", color: "#0A1628" },
            ...
            <View style={styles.table}>
              ...
              {term.payments.map((payment, j) => (
                <View key={`pay-${j}`} style={styles.tableRow}>
                  <Text style={[styles.td, styles.col1, { color: "#10B981" }]}>
                    Payment ({payment.method})
                  </Text>
                  <Text style={[styles.td, styles.col2]}>{payment.date}</Text>
                  <Text style={[styles.td, styles.col3, { color: "#10B981" }]}>
              ...
              <View style={{ width: "50%" }}>
                ...
                <View style={styles.summaryRow}>
                  ...
                  <Text
                    style={[
                      styles.summaryValue,
                      { color: term.balance > 0 ? "#F43F5E" : "#10B981" },
                    ]}
                  >
        ...
        <View style={styles.summary}>
          <View style={styles.balance}>
            ...
            <Text
              style={[
                styles.balanceValue,
                { color: grandBalance > 0 ? "#F43F5E" : "#10B981" },
              ]}
            >
