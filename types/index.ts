...
/**
 * Teacher's class-subject assignment, joined with the class and subject
 * names. This is the canonical shape returned by the
 * `teacher_class_assignments` Supabase query and consumed by the
 * teacher portal layout, sidebar, and assignments page.
 */
